...
def collection_common(data_dir, collection, skip_paths):
    data = ed_ibds.collection_definition.load_common_data(ed_ibds.collection_data.gen_common_file_path(collection, data_dir))
    table = {}
...
def collection_storage_device(data_dir, collection, storage_device):
    data = ed_ibds.file_tree_snapshot.load_index(ed_ibds.collection_data.gen_index_file_path(collection, storage_device, data_dir))
    table = {}
