...
def _scan_collection_storage_device(data_dir, collection_name, storage_device_, data_path, skip_paths, skip_mtime):
...
def scan_storage_device(data_dir, collection_dict, storage_device_, skip_mtime):
    standard_type_assertion.assert_string('data_dir', data_dir)
